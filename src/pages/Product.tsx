        ...
        <div className="max-w-md mx-auto p-4 border  mt-4 shadow-2xl">
            ...
            <div className="flex justify-between">
                ...
                <div className='flex justify-center items-center gap-2'>
                                <button onClick={decrement} className='border w-8 h-8 rounded-full flex justify-center items-center text-2xl font-bold bg-red-600 text-white'>-</button>
                                <div>
                                ...
                                <button onClick={increment} className='border w-8 h-8 rounded-full flex justify-center items-center text-2xl font-bold bg-green-800 text-white'>+</button>
                            </div>      
