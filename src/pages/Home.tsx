  ...
  return (
    <div className="p-4 Poppins-Medium ">
      <form onSubmit={formHandler}>
        <input type="text" placeholder='Search procuct' value={search} onChange={(e)=>setSearch(e.target.value)} className='form-control border w-[94%] m-auto outline-none px-4 py-1 my-4 rounded-s bg-gray-50'/>
